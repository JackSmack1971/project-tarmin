...
export const RENDER_FIXTURES = [
  ...
  "right-opening-1", "t-intersection", "four-way-intersection", "corridor-darkness", "closed-door", "open-door"
] as const;
...
export function createRenderFixture(fixture: RenderFixture): GameState {
  return {
    ...createInitialState(7391), player: { position: { x: 0, y: 0 }, facing: "east" }, walls: fixtureWalls(fixture),
