...
- Acceptance: `harness/build/phase-11-atmosphere-acceptance.md` records A1–A8 as passed. A9 remains pending until feature-branch PR delivery and verified merge to `main`.
