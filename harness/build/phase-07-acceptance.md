...
| P7-VCS-01 | Goal changes are present on `main` through a feature branch and PR. | GitHub/Git inspection | Feature branch commit, PR targeting `main`, required checks, and merged `main` state. | OPEN |
