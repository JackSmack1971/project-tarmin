...
| P9-6 | delivery | must | Commit, PR, required checks, and merge into `main` | Goal commit is present on `main` after PR merge | Git/remote inspection | Branch, PR, checks, and merged SHA | Verified merged commit on `main` | planned |
