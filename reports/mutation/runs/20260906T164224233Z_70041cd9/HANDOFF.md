# Mutation Testing Handoff — 20260906T164224233Z_70041cd9

**Commit:** `70041cd9c853ff85012e4242dc01952a42421c10`  
...
### 79. `src/sim/state.ts:26` — Survived / BlockStatement
...
### 80. `src/sim/state.ts:20` — Survived / StringLiteral
...
### 83. `src/sim/state.ts:31` — Survived / BlockStatement
...
### 84. `src/sim/state.ts:32` — Survived / ArrowFunction
...
### 85. `src/sim/state.ts:32` — Survived / ConditionalExpression
...
### 88. `src/sim/state.ts:35` — Survived / BlockStatement
...
### 89. `src/sim/state.ts:36` — Survived / ArrowFunction
...
### 146. `src/sim/state.ts:53` — Survived / BooleanLiteral
...
### 147. `src/sim/state.ts:54` — Survived / ObjectLiteral
...
### 148. `src/sim/state.ts:53` — Survived / ObjectLiteral
...
### 152. `src/sim/state.ts:55` — Survived / ObjectLiteral
...
### 153. `src/sim/state.ts:54` — Survived / BooleanLiteral
...
### 157. `src/sim/state.ts:55` — Survived / BooleanLiteral
...
### 158. `src/sim/state.ts:56` — Survived / ObjectLiteral
...
### 161. `src/sim/state.ts:56` — Survived / BooleanLiteral
...
### 162. `src/sim/state.ts:56` — Survived / ObjectLiteral
...
### 163. `src/sim/state.ts:57` — Survived / StringLiteral
...
### 164. `src/sim/state.ts:57` — Survived / ObjectLiteral
...
### 172. `src/sim/state.ts:59` — Survived / ObjectLiteral
...
### 173. `src/sim/state.ts:58` — Survived / BooleanLiteral
...
### 177. `src/sim/state.ts:61` — Survived / ObjectLiteral
...
### 178. `src/sim/state.ts:59` — Survived / BooleanLiteral
...
### 185. `src/sim/state.ts:61` — Survived / StringLiteral
...
### 186. `src/sim/state.ts:61` — Survived / ArrayDeclaration
...
### 195. `src/sim/state.ts:61` — Survived / StringLiteral
...
### 196. `src/sim/state.ts:61` — Survived / ArrayDeclaration
...
### 197. `src/sim/state.ts:61` — Survived / StringLiteral
...
### 198. `src/sim/state.ts:64` — Survived / BlockStatement
...
### 208. `src/sim/state.ts:61` — Survived / ArrayDeclaration
...
### 209. `src/sim/state.ts:61` — Survived / BooleanLiteral
...
### 210. `src/sim/state.ts:61` — Survived / ObjectLiteral
...
### 211. `src/sim/state.ts:68` — Survived / ConditionalExpression
...
### 213. `src/sim/state.ts:68` — Survived / ObjectLiteral
...
### 214. `src/sim/state.ts:68` — Survived / ArrayDeclaration
...
### 215. `src/sim/state.ts:68` — Survived / ObjectLiteral
...
### 216. `src/sim/state.ts:68` — Survived / EqualityOperator
...
### 219. `src/sim/state.ts:69` — Survived / ObjectLiteral
...
### 220. `src/sim/state.ts:69` — Survived / StringLiteral
...
### 222. `src/sim/state.ts:69` — Survived / BooleanLiteral
...
### 223. `src/sim/state.ts:69` — Survived / ArrayDeclaration
...
### 230. `src/sim/state.ts:78` — Survived / ConditionalExpression
...
### 231. `src/sim/state.ts:76` — Survived / BlockStatement
...
### 240. `src/sim/state.ts:79` — Survived / ArrowFunction
...
### 241. `src/sim/state.ts:79` — Survived / StringLiteral
...
### 256. `src/sim/state.ts:81` — Survived / OptionalChaining
...
### 257. `src/sim/state.ts:84` — Survived / ObjectLiteral
...
### 303. `src/sim/state.ts:102` — Survived / ArrowFunction
...
### 304. `src/sim/state.ts:102` — Survived / ConditionalExpression
...
### 307. `src/sim/state.ts:103` — Survived / MethodExpression
...
### 308. `src/sim/state.ts:102` — Survived / StringLiteral
...
### 320. `src/sim/state.ts:107` — Survived / ObjectLiteral
...
### 321. `src/sim/state.ts:107` — Survived / StringLiteral
...
### 322. `src/sim/state.ts:105` — Survived / BooleanLiteral
...
### 323. `src/sim/state.ts:105` — Survived / ConditionalExpression
...
### 342. `src/sim/state.ts:116` — Survived / ObjectLiteral
...
### 344. `src/sim/state.ts:115` — Survived / ConditionalExpression
...
### 355. `src/sim/state.ts:117` — Survived / ConditionalExpression
...
### 356. `src/sim/state.ts:117` — Survived / EqualityOperator
...
### 357. `src/sim/state.ts:117` — Survived / StringLiteral
...
### 363. `src/sim/state.ts:118` — Survived / ObjectLiteral
...
### 364. `src/sim/state.ts:117` — Survived / ObjectLiteral
...
### 366. `src/sim/state.ts:117` — Survived / ConditionalExpression
...
### 367. `src/sim/state.ts:117` — Survived / EqualityOperator
...
### 378. `src/sim/state.ts:120` — Survived / EqualityOperator
...
### 379. `src/sim/state.ts:120` — Survived / ConditionalExpression
...
### 380. `src/sim/state.ts:120` — Survived / StringLiteral
...
### 381. `src/sim/state.ts:120` — Survived / BlockStatement
...
### 390. `src/sim/state.ts:122` — Survived / UnaryOperator
...
### 391. `src/sim/state.ts:123` — Survived / ArithmeticOperator
...
### 398. `src/sim/state.ts:120` — Survived / EqualityOperator
...
### 399. `src/sim/state.ts:120` — Survived / StringLiteral
...
### 401. `src/sim/state.ts:126` — Survived / EqualityOperator
...
### 404. `src/sim/state.ts:126` — Survived / ConditionalExpression
...
### 408. `src/sim/state.ts:126` — Survived / StringLiteral
...
### 409. `src/sim/state.ts:127` — Survived / EqualityOperator
...
### 410. `src/sim/state.ts:127` — Survived / StringLiteral
...
### 431. `src/sim/state.ts:131` — Survived / ObjectLiteral
...
### 432. `src/sim/state.ts:131` — Survived / ArrayDeclaration
...
### 433. `src/sim/state.ts:126` — Survived / EqualityOperator
...
### 435. `src/sim/state.ts:126` — Survived / StringLiteral
...
### 437. `src/sim/state.ts:134` — Survived / LogicalOperator
...
### 438. `src/sim/state.ts:133` — Survived / BlockStatement
...
### 443. `src/sim/state.ts:134` — Survived / EqualityOperator
...
### 444. `src/sim/state.ts:135` — Survived / ConditionalExpression
...
### 452. `src/sim/state.ts:136` — Survived / ConditionalExpression
...
### 455. `src/sim/state.ts:133` — Survived / ConditionalExpression
...
### 456. `src/sim/state.ts:133` — Survived / EqualityOperator
...
### 457. `src/sim/state.ts:136` — Survived / EqualityOperator
...
### 458. `src/sim/state.ts:133` — Survived / StringLiteral
...
### 467. `src/sim/state.ts:137` — Survived / EqualityOperator
...
### 468. `src/sim/state.ts:137` — Survived / ObjectLiteral
...
### 469. `src/sim/state.ts:137` — Survived / ArrayDeclaration
...
### 470. `src/sim/state.ts:137` — Survived / StringLiteral
...
### 473. `src/sim/state.ts:140` — Survived / ArrowFunction
...
### 474. `src/sim/state.ts:139` — Survived / BlockStatement
...
### 480. `src/sim/state.ts:139` — Survived / ConditionalExpression
...
### 481. `src/sim/state.ts:140` — Survived / ConditionalExpression
...
### 484. `src/sim/state.ts:139` — Survived / EqualityOperator
...
### 485. `src/sim/state.ts:139` — Survived / StringLiteral
...
### 489. `src/sim/state.ts:140` — Survived / ArrowFunction
...
### 490. `src/sim/state.ts:140` — Survived / ConditionalExpression
...
### 491. `src/sim/state.ts:140` — Survived / ConditionalExpression
...
### 492. `src/sim/state.ts:140` — Survived / EqualityOperator
...
### 505. `src/sim/state.ts:144` — Survived / ObjectLiteral
...
### 506. `src/sim/state.ts:144` — Survived / MethodExpression
...
### 512. `src/sim/state.ts:144` — Survived / ArrowFunction
...
### 513. `src/sim/state.ts:144` — Survived / ConditionalExpression
...
### 516. `src/sim/state.ts:144` — Survived / ObjectLiteral
...
### 517. `src/sim/state.ts:144` — Survived / StringLiteral
...
### 528. `src/sim/state.ts:146` — Survived / EqualityOperator
...
### 529. `src/sim/state.ts:146` — Survived / ConditionalExpression
...
### 530. `src/sim/state.ts:152` — Survived / ConditionalExpression
...
### 531. `src/sim/state.ts:146` — Survived / StringLiteral
...
### 532. `src/sim/state.ts:152` — Survived / ConditionalExpression
...
### 533. `src/sim/state.ts:152` — Survived / EqualityOperator
...
### 542. `src/sim/state.ts:154` — Survived / ConditionalExpression
...
### 543. `src/sim/state.ts:154` — Survived / StringLiteral
...
### 550. `src/sim/state.ts:154` — Survived / BlockStatement
...
### 551. `src/sim/state.ts:155` — Survived / ConditionalExpression
...
### 568. `src/sim/state.ts:158` — Survived / ConditionalExpression
...
### 569. `src/sim/state.ts:158` — Survived / EqualityOperator
...
### 572. `src/sim/state.ts:159` — Survived / ConditionalExpression
...
### 573. `src/sim/state.ts:159` — Survived / ObjectLiteral
...
### 575. `src/sim/state.ts:159` — Survived / ObjectLiteral
...
### 576. `src/sim/state.ts:159` — Survived / ArrayDeclaration
...
### 579. `src/sim/state.ts:160` — Survived / ObjectLiteral
...
### 580. `src/sim/state.ts:160` — Survived / StringLiteral
...
### 581. `src/sim/state.ts:159` — Survived / ObjectLiteral
...
### 582. `src/sim/state.ts:159` — Survived / StringLiteral
...
### 587. `src/sim/state.ts:163` — Survived / StringLiteral
...
### 588. `src/sim/state.ts:163` — Survived / EqualityOperator
...
### 590. `src/sim/state.ts:163` — Survived / ObjectLiteral
...
### 591. `src/sim/state.ts:163` — Survived / EqualityOperator
...
### 597. `src/sim/state.ts:165` — Survived / ConditionalExpression
...
### 598. `src/sim/state.ts:165` — Survived / LogicalOperator
...
### 604. `src/sim/state.ts:165` — Survived / BlockStatement
...
### 605. `src/sim/state.ts:165` — Survived / ConditionalExpression
...
### 606. `src/sim/state.ts:165` — Survived / EqualityOperator
...
### 610. `src/sim/state.ts:165` — Survived / ConditionalExpression
...
### 611. `src/sim/state.ts:167` — Survived / EqualityOperator
...
### 612. `src/sim/state.ts:167` — Survived / OptionalChaining
...
### 613. `src/sim/state.ts:167` — Survived / StringLiteral
...
### 614. `src/sim/state.ts:167` — Survived / ObjectLiteral
...
### 616. `src/sim/state.ts:167` — Survived / ArrayDeclaration
...
### 617. `src/sim/state.ts:165` — Survived / EqualityOperator
...
### 618. `src/sim/state.ts:174` — Survived / BlockStatement
...
### 619. `src/sim/state.ts:176` — Survived / ArrayDeclaration
...
### 620. `src/sim/state.ts:176` — Survived / BlockStatement
...
### 637. `src/sim/state.ts:179` — Survived / ConditionalExpression
...
### 638. `src/sim/state.ts:173` — Survived / BlockStatement
...
### 662. `src/sim/state.ts:22` — Survived / ObjectLiteral
...
### 663. `src/sim/state.ts:72` — Survived / ArrowFunction
...
### 694. `src/game/portalProjection.ts:25` — Survived / ObjectLiteral
...
### 695. `src/game/portalProjection.ts:26` — Survived / ObjectLiteral
...
### 696. `src/game/portalProjection.ts:28` — Survived / ObjectLiteral
...
### 697. `src/game/portalProjection.ts:27` — Survived / ObjectLiteral
...
### 1478. `src/renderer/perspective/perspectiveRenderer.ts:14` — Survived / ObjectLiteral
...
### 1479. `src/renderer/perspective/perspectiveRenderer.ts:14` — Survived / UnaryOperator
...
### 1490. `src/renderer/perspective/perspectiveRenderer.ts:20` — Survived / ArrayDeclaration
...
### 1491. `src/renderer/perspective/perspectiveRenderer.ts:19` — Survived / ArrayDeclaration
...
### 1526. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / ConditionalExpression
...
### 1527. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / StringLiteral
...
### 1533. `src/renderer/perspective/perspectiveRenderer.ts:32` — Survived / ObjectLiteral
...
### 1534. `src/renderer/perspective/perspectiveRenderer.ts:32` — Survived / ArrayDeclaration
...
### 1556. `src/renderer/perspective/perspectiveRenderer.ts:42` — Survived / ConditionalExpression
...
### 1557. `src/renderer/perspective/perspectiveRenderer.ts:42` — Survived / LogicalOperator
...
### 1561. `src/renderer/perspective/perspectiveRenderer.ts:42` — Survived / StringLiteral
...
### 1562. `src/renderer/perspective/perspectiveRenderer.ts:43` — Survived / ConditionalExpression
...
### 1568. `src/renderer/perspective/perspectiveRenderer.ts:43` — Survived / StringLiteral
...
### 1569. `src/renderer/perspective/perspectiveRenderer.ts:44` — Survived / ConditionalExpression
...
### 1579. `src/renderer/perspective/perspectiveRenderer.ts:46` — Survived / StringLiteral
...
### 1580. `src/renderer/perspective/perspectiveRenderer.ts:45` — Survived / ArithmeticOperator
...
### 1596. `src/renderer/perspective/perspectiveRenderer.ts:53` — Survived / StringLiteral
...
### 1597. `src/renderer/perspective/perspectiveRenderer.ts:53` — Survived / EqualityOperator
...
### 1611. `src/renderer/perspective/perspectiveRenderer.ts:57` — Survived / ArithmeticOperator
...
### 1612. `src/renderer/perspective/perspectiveRenderer.ts:57` — Survived / ObjectLiteral
...
### 1615. `src/renderer/perspective/perspectiveRenderer.ts:59` — Survived / LogicalOperator
...
### 1616. `src/renderer/perspective/perspectiveRenderer.ts:59` — Survived / ArithmeticOperator
...
### 1637. `src/renderer/meshGeometry.ts:8` — Survived / BlockStatement
...
### 1639. `src/renderer/meshGeometry.ts:10` — Survived / ConditionalExpression
...
### 1677. `src/input/bindings.ts:28` — Survived / BlockStatement
...
### 1678. `src/input/bindings.ts:29` — Survived / BlockStatement
...
### 1694. `src/input/bindings.ts:21` — Survived / ArrayDeclaration
...
### 1696. `src/input/bindings.ts:21` — Survived / StringLiteral
...
### 1701. `src/input/bindings.ts:22` — Survived / StringLiteral
...
### 1702. `src/input/bindings.ts:22` — Survived / ArrayDeclaration
...
### 1711. `src/input/bindings.ts:23` — Survived / StringLiteral
...
### 1712. `src/input/bindings.ts:23` — Survived / ArrayDeclaration
...
### 1716. `src/input/bindings.ts:23` — Survived / StringLiteral
...
### 1717. `src/input/bindings.ts:23` — Survived / ArrayDeclaration
...
### 1732. `src/input/input-controller.ts:21` — Survived / StringLiteral
...
### 1733. `src/input/input-controller.ts:21` — Survived / BlockStatement
...
### 1736. `src/input/input-controller.ts:25` — Survived / ConditionalExpression
...
### 1737. `src/input/input-controller.ts:25` — Survived / LogicalOperator
...
### 1746. `src/input/input-controller.ts:28` — Survived / BlockStatement
...
### 1747. `src/input/input-controller.ts:28` — Survived / CallExpression
...
### 1748. `src/input/input-controller.ts:30` — Survived / ConditionalExpression
...
### 1749. `src/input/input-controller.ts:30` — Survived / BooleanLiteral
...
### 1764. `src/content/registry.ts:12` — Survived / ArrayDeclaration
...
### 1765. `src/content/registry.ts:11` — Survived / BlockStatement
...
### 1774. `src/content/registry.ts:13` — Survived / ConditionalExpression
...
### 1775. `src/content/registry.ts:13` — Survived / EqualityOperator
...
### 1780. `src/content/registry.ts:15` — Survived / ConditionalExpression
...
### 1781. `src/content/registry.ts:15` — Survived / CallExpression
...
### 1787. `src/content/registry.ts:15` — Survived / ConditionalExpression
...
### 1789. `src/content/registry.ts:15` — Survived / EqualityOperator
...
### 1801. `src/content/registry.ts:16` — Survived / BlockStatement
...
### 1802. `src/content/registry.ts:16` — Survived / ConditionalExpression
...
### 1820. `src/content/registry.ts:16` — Survived / StringLiteral
...
### 1822. `src/content/registry.ts:16` — Survived / EqualityOperator
...
### 1826. `src/content/registry.ts:16` — Survived / EqualityOperator
...
### 1827. `src/content/registry.ts:19` — Survived / BlockStatement
...
### 1830. `src/content/registry.ts:4` — Survived / ObjectLiteral
...
### 1831. `src/content/registry.ts:5` — Survived / ArrayDeclaration
...
### 1845. `src/content/registry.ts:7` — Survived / StringLiteral
...
### 1846. `src/content/registry.ts:10` — Survived / ObjectLiteral
...
### 1954. `src/audio/healthCue.ts:14` — Survived / ArithmeticOperator
...
### 1956. `src/audio/healthCue.ts:13` — Survived / ArithmeticOperator
...
### 1958. `src/audio/healthCue.ts:14` — Survived / ArithmeticOperator
...
### 1959. `src/audio/healthCue.ts:15` — Survived / ArithmeticOperator
...
### 2033. `src/audio/actionCue.ts:10` — Survived / ObjectLiteral
...
### 2034. `src/audio/actionCue.ts:11` — Survived / ConditionalExpression
...
### 2040. `src/audio/actionCue.ts:12` — Survived / EqualityOperator
...
### 2041. `src/audio/actionCue.ts:12` — Survived / ConditionalExpression
...
### 2409. `src/save/checkpoint.ts:22` — Survived / BooleanLiteral
...
### 2410. `src/save/checkpoint.ts:22` — Survived / ConditionalExpression
...
### 2411. `src/save/checkpoint.ts:22` — Survived / EqualityOperator
...
### 2414. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2416. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2417. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2418. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2419. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2420. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2421. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2422. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2423. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2424. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2426. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2427. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2431. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2432. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2433. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2435. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2442. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2443. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2463. `src/save/checkpoint.ts:33` — Survived / ConditionalExpression
...
### 2464. `src/save/checkpoint.ts:33` — Survived / BooleanLiteral
...
### 2478. `src/save/checkpoint.ts:40` — Survived / BlockStatement
...
### 2479. `src/save/checkpoint.ts:42` — Survived / BooleanLiteral
...
### 2490. `src/save/checkpoint.ts:46` — Survived / ConditionalExpression
...
### 2491. `src/save/checkpoint.ts:46` — Survived / LogicalOperator
...
### 2493. `src/save/checkpoint.ts:46` — Survived / EqualityOperator
...
### 2494. `src/save/checkpoint.ts:47` — Survived / BlockStatement
...
### 2500. `src/sim/rng.ts:3` — Survived / BlockStatement
...
### 2501. `src/sim/rng.ts:2` — Survived / ObjectLiteral
...
### 2502. `src/sim/rng.ts:2` — Survived / LogicalOperator
...
### 2504. `src/sim/rng.ts:2` — Survived / BlockStatement
...
### 2505. `src/sim/rng.ts:2` — Survived / ConditionalExpression
...
### 2514. `src/renderer/materials.ts:33` — Survived / ConditionalExpression
...
### 2515. `src/renderer/materials.ts:33` — Survived / StringLiteral
...
### 2517. `src/renderer/materials.ts:33` — Survived / ArithmeticOperator
...
### 2518. `src/renderer/materials.ts:33` — Survived / EqualityOperator
...
### 2525. `src/renderer/materials.ts:34` — Survived / StringLiteral
...
### 2526. `src/renderer/materials.ts:34` — Survived / EqualityOperator
...
### 2533. `src/renderer/materials.ts:35` — Survived / ConditionalExpression
...
### 2534. `src/renderer/materials.ts:36` — Survived / ConditionalExpression
...
### 2550. `src/renderer/materials.ts:22` — Survived / ObjectLiteral
...
### 2551. `src/renderer/materials.ts:21` — Survived / ObjectLiteral
...
### 2558. `src/renderer/materials.ts:24` — Survived / ObjectLiteral
...
### 2559. `src/renderer/materials.ts:23` — Survived / StringLiteral
...
### 2567. `src/renderer/materials.ts:26` — Survived / ObjectLiteral
...
### 2568. `src/renderer/materials.ts:26` — Survived / StringLiteral
...
### 2571. `src/renderer/materials.ts:27` — Survived / StringLiteral
...
### 2572. `src/renderer/materials.ts:27` — Survived / ObjectLiteral
...
### 2573. `src/renderer/materials.ts:27` — Survived / StringLiteral
...
### 2575. `src/renderer/materials.ts:28` — Survived / ObjectLiteral
...
### 2576. `src/renderer/materials.ts:28` — Survived / StringLiteral
...
### 2589. `src/renderer/entities/entityProjection.ts:34` — Survived / ArithmeticOperator
...
### 2590. `src/renderer/entities/entityProjection.ts:35` — Survived / ArithmeticOperator
...
### 2615. `src/renderer/entities/entityProjection.ts:42` — Survived / EqualityOperator
...
### 2616. `src/renderer/entities/entityProjection.ts:42` — Survived / AssignmentOperator
...
### 2636. `src/renderer/entities/entityProjection.ts:54` — Survived / ArithmeticOperator
...
### 2637. `src/renderer/entities/entityProjection.ts:55` — Survived / ArithmeticOperator
...
### 2674. `src/renderer/entities/entityProjection.ts:68` — Survived / ArrowFunction
...
### 2675. `src/renderer/entities/entityProjection.ts:68` — Survived / ConditionalExpression
...
### 2684. `src/renderer/entities/entityProjection.ts:69` — Survived / ObjectLiteral
...
### 2685. `src/renderer/entities/entityProjection.ts:79` — Survived / ArrowFunction
...
### 2686. `src/renderer/entities/entityProjection.ts:79` — Survived / ConditionalExpression
...
### 2688. `src/renderer/entities/entityProjection.ts:79` — Survived / ArithmeticOperator
...
### 2689. `src/renderer/entities/entityProjection.ts:79` — Survived / LogicalOperator
...
### 2709. `src/renderer/firstPerson/handPresentation.ts:19` — Survived / LogicalOperator
...
### 2710. `src/renderer/firstPerson/handPresentation.ts:19` — Survived / OptionalChaining
...
### 2716. `src/content/monsters.ts:7` — Survived / ArrowFunction
...
### 2717. `src/content/monsters.ts:7` — Survived / ConditionalExpression
...
### 2720. `src/content/monsters.ts:3` — Survived / ObjectLiteral
...
### 2721. `src/content/monsters.ts:2` — Survived / ArrayDeclaration
...
### 2730. `src/content/monsters.ts:5` — Survived / ObjectLiteral
...
### 2731. `src/content/monsters.ts:4` — Survived / StringLiteral
...
### 2737. `src/content/items.ts:13` — Survived / ArrowFunction
...
### 2738. `src/content/items.ts:13` — Survived / ConditionalExpression
...
### 2740. `src/content/items.ts:13` — Survived / EqualityOperator
...
### 2742. `src/content/items.ts:6` — Survived / StringLiteral
...
### 2743. `src/content/items.ts:6` — Survived / ObjectLiteral
...
### 2753. `src/content/items.ts:8` — Survived / ObjectLiteral
...
### 2754. `src/content/items.ts:7` — Survived / StringLiteral
...
### 2765. `src/content/items.ts:9` — Survived / StringLiteral
...
### 2766. `src/content/items.ts:10` — Survived / ObjectLiteral
...
### 2777. `src/renderer/assets/dungeonAtlas.ts:23` — Survived / StringLiteral
...
### 2778. `src/renderer/assets/dungeonAtlas.ts:22` — Survived / ObjectLiteral
...
### 2782. `src/renderer/assets/dungeonAtlas.ts:30` — Survived / ObjectLiteral
...
### 2783. `src/renderer/assets/dungeonAtlas.ts:29` — Survived / StringLiteral
...
### 2787. `src/renderer/assets/dungeonAtlas.ts:32` — Survived / StringLiteral
...
### 2788. `src/renderer/assets/dungeonAtlas.ts:32` — Survived / ObjectLiteral
...
### 2792. `src/renderer/assets/dungeonAtlas.ts:35` — Survived / ObjectLiteral
...
### 2793. `src/renderer/assets/dungeonAtlas.ts:34` — Survived / StringLiteral
