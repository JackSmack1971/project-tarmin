# Mutation Testing Handoff — 20260906T161100751Z_04d38766

**Commit:** `04d387663a8da42b7f08db1b05d256ccdc65c641`  
...
### 107. `src/sim/state.ts:50` — Survived / CallExpression
...
### 108. `src/sim/state.ts:49` — Survived / BlockStatement
...
### 153. `src/sim/state.ts:55` — Survived / StringLiteral
...
### 154. `src/sim/state.ts:55` — Survived / ObjectLiteral
...
### 187. `src/sim/state.ts:61` — Survived / StringLiteral
...
### 188. `src/sim/state.ts:61` — Survived / ArrayDeclaration
...
### 209. `src/sim/state.ts:61` — Survived / ObjectLiteral
...
### 210. `src/sim/state.ts:68` — Survived / ObjectLiteral
...
### 212. `src/sim/state.ts:68` — Survived / EqualityOperator
...
### 214. `src/sim/state.ts:61` — Survived / BooleanLiteral
...
### 227. `src/sim/state.ts:73` — Survived / LogicalOperator
...
### 228. `src/sim/state.ts:72` — Survived / EqualityOperator
...
### 253. `src/sim/state.ts:81` — Survived / StringLiteral
...
### 254. `src/sim/state.ts:81` — Survived / BooleanLiteral
...
### 263. `src/sim/state.ts:86` — Survived / ArithmeticOperator
...
### 264. `src/sim/state.ts:85` — Survived / ArithmeticOperator
...
### 272. `src/sim/state.ts:89` — Survived / StringLiteral
...
### 273. `src/sim/state.ts:89` — Survived / ObjectLiteral
...
### 309. `src/sim/state.ts:104` — Survived / ConditionalExpression
...
### 310. `src/sim/state.ts:103` — Survived / ArithmeticOperator
...
### 312. `src/sim/state.ts:105` — Survived / BlockStatement
...
### 313. `src/sim/state.ts:104` — Survived / StringLiteral
...
### 314. `src/sim/state.ts:104` — Survived / ObjectLiteral
...
### 315. `src/sim/state.ts:106` — Survived / ObjectLiteral
...
### 318. `src/sim/state.ts:107` — Survived / ObjectLiteral
...
### 319. `src/sim/state.ts:106` — Survived / StringLiteral
...
### 321. `src/sim/state.ts:105` — Survived / BooleanLiteral
...
### 333. `src/sim/state.ts:113` — Survived / ConditionalExpression
...
### 334. `src/sim/state.ts:112` — Survived / BlockStatement
...
### 343. `src/sim/state.ts:115` — Survived / ConditionalExpression
...
### 345. `src/sim/state.ts:116` — Survived / ObjectLiteral
...
### 356. `src/sim/state.ts:117` — Survived / StringLiteral
...
### 357. `src/sim/state.ts:117` — Survived / ConditionalExpression
...
### 358. `src/sim/state.ts:117` — Survived / EqualityOperator
...
### 377. `src/sim/state.ts:120` — Survived / BlockStatement
...
### 378. `src/sim/state.ts:120` — Survived / StringLiteral
...
### 380. `src/sim/state.ts:120` — Survived / EqualityOperator
...
### 381. `src/sim/state.ts:120` — Survived / ConditionalExpression
...
### 389. `src/sim/state.ts:122` — Survived / UnaryOperator
...
### 400. `src/sim/state.ts:126` — Survived / LogicalOperator
...
### 402. `src/sim/state.ts:126` — Survived / ConditionalExpression
...
### 404. `src/sim/state.ts:126` — Survived / BlockStatement
...
### 405. `src/sim/state.ts:126` — Survived / EqualityOperator
...
### 409. `src/sim/state.ts:126` — Survived / StringLiteral
...
### 410. `src/sim/state.ts:126` — Survived / ConditionalExpression
...
### 412. `src/sim/state.ts:127` — Survived / StringLiteral
...
### 432. `src/sim/state.ts:126` — Survived / StringLiteral
...
### 434. `src/sim/state.ts:131` — Survived / ArrayDeclaration
...
### 435. `src/sim/state.ts:131` — Survived / ObjectLiteral
...
### 457. `src/sim/state.ts:133` — Survived / EqualityOperator
...
### 482. `src/sim/state.ts:139` — Survived / ConditionalExpression
...
### 503. `src/sim/state.ts:144` — Survived / ObjectLiteral
...
### 504. `src/sim/state.ts:143` — Survived / EqualityOperator
...
### 507. `src/sim/state.ts:144` — Survived / ConditionalExpression
...
### 508. `src/sim/state.ts:144` — Survived / ArrowFunction
...
### 529. `src/sim/state.ts:146` — Survived / EqualityOperator
...
### 530. `src/sim/state.ts:146` — Survived / StringLiteral
...
### 538. `src/sim/state.ts:154` — Survived / ConditionalExpression
...
### 539. `src/sim/state.ts:152` — Survived / StringLiteral
...
### 565. `src/sim/state.ts:157` — Survived / BooleanLiteral
...
### 566. `src/sim/state.ts:157` — Survived / BlockStatement
...
### 576. `src/sim/state.ts:161` — Survived / ObjectLiteral
...
### 577. `src/sim/state.ts:159` — Survived / ArrayDeclaration
...
### 602. `src/sim/state.ts:165` — Survived / StringLiteral
...
### 603. `src/sim/state.ts:165` — Survived / EqualityOperator
...
### 613. `src/sim/state.ts:165` — Survived / ConditionalExpression
...
### 615. `src/sim/state.ts:167` — Survived / ArrayDeclaration
...
### 616. `src/sim/state.ts:168` — Survived / CallExpression
...
### 618. `src/sim/state.ts:165` — Survived / EqualityOperator
...
### 643. `src/sim/state.ts:17` — Survived / UnaryOperator
...
### 645. `src/sim/state.ts:17` — Survived / ObjectLiteral
...
### 659. `src/sim/state.ts:22` — Survived / ObjectLiteral
...
### 660. `src/sim/state.ts:19` — Survived / StringLiteral
...
### 661. `src/sim/state.ts:20` — Survived / ArrowFunction
...
### 662. `src/sim/state.ts:24` — Survived / ArrowFunction
...
### 664. `src/sim/state.ts:73` — Survived / ArrowFunction
...
### 665. `src/sim/state.ts:74` — Survived / ArrowFunction
...
### 692. `src/game/portalProjection.ts:24` — Survived / ObjectLiteral
...
### 693. `src/game/portalProjection.ts:23` — Survived / ObjectLiteral
...
### 699. `src/game/portalProjection.ts:31` — Survived / ObjectLiteral
...
### 700. `src/game/portalProjection.ts:30` — Survived / ObjectLiteral
...
### 1488. `src/renderer/perspective/perspectiveRenderer.ts:18` — Survived / BlockStatement
...
### 1489. `src/renderer/perspective/perspectiveRenderer.ts:15` — Survived / ArithmeticOperator
...
### 1492. `src/renderer/perspective/perspectiveRenderer.ts:22` — Survived / BlockStatement
...
### 1493. `src/renderer/perspective/perspectiveRenderer.ts:22` — Survived / ArrayDeclaration
...
### 1509. `src/renderer/perspective/perspectiveRenderer.ts:27` — Survived / ConditionalExpression
...
### 1510. `src/renderer/perspective/perspectiveRenderer.ts:26` — Survived / StringLiteral
...
### 1513. `src/renderer/perspective/perspectiveRenderer.ts:27` — Survived / ArithmeticOperator
...
### 1514. `src/renderer/perspective/perspectiveRenderer.ts:27` — Survived / UnaryOperator
...
### 1520. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / ConditionalExpression
...
### 1521. `src/renderer/perspective/perspectiveRenderer.ts:30` — Survived / ArithmeticOperator
...
### 1524. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / EqualityOperator
...
### 1525. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / ConditionalExpression
...
### 1527. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / EqualityOperator
...
### 1528. `src/renderer/perspective/perspectiveRenderer.ts:31` — Survived / ConditionalExpression
...
### 1550. `src/renderer/perspective/perspectiveRenderer.ts:37` — Survived / StringLiteral
...
### 1551. `src/renderer/perspective/perspectiveRenderer.ts:36` — Survived / StringLiteral
...
### 1552. `src/renderer/perspective/perspectiveRenderer.ts:41` — Survived / StringLiteral
...
### 1553. `src/renderer/perspective/perspectiveRenderer.ts:40` — Survived / StringLiteral
...
### 1558. `src/renderer/perspective/perspectiveRenderer.ts:42` — Survived / EqualityOperator
...
### 1559. `src/renderer/perspective/perspectiveRenderer.ts:42` — Survived / StringLiteral
...
### 1565. `src/renderer/perspective/perspectiveRenderer.ts:43` — Survived / ConditionalExpression
...
### 1566. `src/renderer/perspective/perspectiveRenderer.ts:43` — Survived / EqualityOperator
...
### 1641. `src/renderer/meshGeometry.ts:10` — Survived / EqualityOperator
...
### 1642. `src/renderer/meshGeometry.ts:11` — Survived / ConditionalExpression
...
### 1643. `src/renderer/meshGeometry.ts:11` — Survived / BooleanLiteral
...
### 1659. `src/renderer/meshGeometry.ts:22` — Survived / ArrowFunction
...
### 1660. `src/renderer/meshGeometry.ts:17` — Survived / ArrayDeclaration
...
### 1661. `src/renderer/meshGeometry.ts:20` — Survived / BlockStatement
...
### 1737. `src/input/input-controller.ts:26` — Survived / ConditionalExpression
...
### 1738. `src/input/input-controller.ts:25` — Survived / LogicalOperator
...
### 1768. `src/content/registry.ts:13` — Survived / CallExpression
...
### 1769. `src/content/registry.ts:13` — Survived / ConditionalExpression
...
### 1773. `src/content/registry.ts:13` — Survived / EqualityOperator
...
### 1778. `src/content/registry.ts:15` — Survived / ConditionalExpression
...
### 1779. `src/content/registry.ts:15` — Survived / BlockStatement
...
### 1790. `src/content/registry.ts:15` — Survived / EqualityOperator
...
### 1791. `src/content/registry.ts:15` — Survived / ConditionalExpression
...
### 1792. `src/content/registry.ts:15` — Survived / StringLiteral
...
### 1803. `src/content/registry.ts:16` — Survived / ConditionalExpression
...
### 1804. `src/content/registry.ts:16` — Survived / LogicalOperator
...
### 1805. `src/content/registry.ts:16` — Survived / MethodExpression
...
### 1806. `src/content/registry.ts:16` — Survived / BooleanLiteral
...
### 1807. `src/content/registry.ts:16` — Survived / ArrowFunction
...
### 1808. `src/content/registry.ts:16` — Survived / StringLiteral
...
### 1811. `src/content/registry.ts:16` — Survived / BooleanLiteral
...
### 1812. `src/content/registry.ts:16` — Survived / EqualityOperator
...
### 1827. `src/content/registry.ts:19` — Survived / ConditionalExpression
...
### 1828. `src/content/registry.ts:16` — Survived / EqualityOperator
...
### 1837. `src/content/registry.ts:6` — Survived / StringLiteral
...
### 1838. `src/content/registry.ts:6` — Survived / ObjectLiteral
...
### 1842. `src/content/registry.ts:7` — Survived / ObjectLiteral
...
### 1843. `src/content/registry.ts:7` — Survived / StringLiteral
...
### 2041. `src/audio/actionCue.ts:12` — Survived / StringLiteral
...
### 2042. `src/audio/actionCue.ts:12` — Survived / EqualityOperator
...
### 2415. `src/save/checkpoint.ts:24` — Survived / LogicalOperator
...
### 2434. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2441. `src/save/checkpoint.ts:24` — Survived / ConditionalExpression
...
### 2462. `src/save/checkpoint.ts:33` — Survived / BooleanLiteral
...
### 2463. `src/save/checkpoint.ts:33` — Survived / LogicalOperator
...
### 2500. `src/sim/rng.ts:2` — Survived / ObjectLiteral
...
### 2501. `src/sim/rng.ts:2` — Survived / LogicalOperator
...
### 2504. `src/sim/rng.ts:2` — Survived / ConditionalExpression
...
### 2510. `src/renderer/materials.ts:32` — Survived / BlockStatement
...
### 2511. `src/renderer/materials.ts:33` — Survived / ConditionalExpression
...
### 2534. `src/renderer/materials.ts:35` — Survived / EqualityOperator
...
### 2535. `src/renderer/materials.ts:36` — Survived / ConditionalExpression
...
### 2544. `src/renderer/materials.ts:37` — Survived / ConditionalExpression
...
### 2545. `src/renderer/materials.ts:37` — Survived / StringLiteral
...
### 2710. `src/renderer/firstPerson/handPresentation.ts:27` — Survived / BlockStatement
...
### 2711. `src/renderer/firstPerson/handPresentation.ts:19` — Survived / OptionalChaining
...
### 2726. `src/content/monsters.ts:4` — Survived / StringLiteral
...
### 2727. `src/content/monsters.ts:4` — Survived / ObjectLiteral
...
### 2785. `src/renderer/assets/dungeonAtlas.ts:31` — Survived / StringLiteral
...
### 2786. `src/renderer/assets/dungeonAtlas.ts:31` — Survived / ObjectLiteral
